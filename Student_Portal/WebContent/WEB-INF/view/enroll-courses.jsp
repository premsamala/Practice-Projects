<%@page import="com.studentportal.entity.Course"%>
...
<body>
	...
	<div class="container">
		<h2 class="mt-4 mb-0 text-center">Please select the courses to be enrolled</h2>
	</div>
	<div class="container">

		<form:form action="processrequest" modelAttribute="student">
					...
					<c:forEach var="temp" items="${courses}">
						...
						<tr>
							...
							<td><form:checkbox path="courseSelection"
									value="${temp.courseId}" />${temp.courseId}</td>
