					...
					<div class="card-body">
						...
						<div class="text-center">
							<a href="register" class="btn btn-primary mx-auto center-block"
								role="button">Register new instructor</a> <a href="manageinstructor"
								class="btn btn-primary mx-auto " role="button">Manage Instructors</a> 
						</div>
						<br>
						<br>
						<br>
						<a href="backtomenu" class="btn btn-primary mx-auto " role="button">Go
							back to main menu</a>
