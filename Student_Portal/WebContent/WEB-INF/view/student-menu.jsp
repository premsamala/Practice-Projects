					...
					<div class="card-body">
						...
						<div class="text-center">
							<a href="register" class="btn btn-primary mx-auto center-block"
								role="button">Register a Student</a> <a href="displayStudents"
								class="btn btn-primary mx-auto " role="button">Display
								Students</a> 
						</div>
						<br>
						<br>
						<br>
						<a href="mainmenu" class="btn btn-primary mx-auto " role="button">Go
							back to main menu</a>
